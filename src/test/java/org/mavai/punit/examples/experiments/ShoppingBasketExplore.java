...
import static org.mavai.punit.examples.servicecontracts.ShoppingBasketSampleSizes.EXPLORE_PER_CONFIG_SAMPLE_SIZE;
 ...
 * }</pre>
 */
// mavai-ref: JVI-9QC7E6Z — do not remove (resolves in mavai-orchestrator)
