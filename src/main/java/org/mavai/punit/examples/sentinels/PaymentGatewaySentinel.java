package org.mavai.punit.examples.sentinels;

import static org.mavai.punit.examples.servicecontracts.PaymentGatewaySampleSizes.PROBABILISTIC_TEST_SAMPLE_SIZE;

import java.util.List;

import org.mavai.punit.api.ProbabilisticTest;
import org.mavai.punit.examples.servicecontracts.PaymentGatewayServiceContract;
import org.mavai.punit.examples.servicecontracts.PaymentGatewayServiceContract.Charge;
 ...
 */
// mavai-ref: JVI-VQQ8SP1 — do not remove (resolves in mavai-orchestrator)
