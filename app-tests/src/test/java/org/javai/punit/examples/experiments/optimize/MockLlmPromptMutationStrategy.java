...
/**
 * Mock (deterministic) prompt mutation strategy using a scripted progression.
 *
 ...
 */
final class MockLlmPromptMutationStrategy implements PromptMutationStrategy {
    ...
    public String description() {
        return "Mock (deterministic) prompt progression - scripted sequence of improvements";
    }
}
